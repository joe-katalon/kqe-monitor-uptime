...
First of all, thank you everyone who made pull requests for Uptime Katalon, I never thought GitHub Community can be that nice! And also because of this, I also never thought other people actually read my code and edit my code. It is not structured and commented so well, lol. Sorry about that.
...
## Can I create a pull request for Uptime Katalon?
...
- Buggy
- UI/UX is not close to Uptime Katalon 
...
Uptime Katalon Frontend is a single page application (SPA). Most paths are handled by Vue Router.
