...
"echo" "-e" "====================="
"echo" "-e" "Uptime Katalon Installer"
"echo" "-e" "====================="
...
"echo" "-e" "---------------------------------------"
"echo" "-e" ""
"echo" "-e" "Local - Install Uptime Katalon in your current machine with git, Node.js 14 and pm2"
"echo" "-e" "Docker - Install Uptime Katalon Docker container"
"echo" "-e" ""
if [ "$1" != "" ]; then
  type="$1"
else
