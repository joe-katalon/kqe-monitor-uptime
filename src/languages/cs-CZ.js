export default {
    ...
    "disableauth.message2": "Tato možnost je určena pro případy, kdy <strong>máte autentifikaci zajištěnou třetí stranou</strong> ještě před přístupem do Uptime Katalon, například prostřednictvím Cloudflare Access.",
    ...
    aboutKumaURL: "Pokud ponecháte pole URL adresa Uptime Katalon prázdné, použije se domovská stránka GitHub projektu.",
    ...
    trustProxyDescription: "Důvěřovat 'X-Forwarded-*' hlavičkám. Pokud chcete získat správnou IP adresu klientů a vaše instance Uptime Katalon je schována za Nginx nebo Apache, měli byste tuto možnost zapnout.",
