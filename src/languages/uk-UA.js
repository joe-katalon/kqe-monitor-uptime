export default {
    ...
    "disableauth.message2": "Це підходить для <strong>тих, у кого встановлена інша авторизація</strong> пееред відкриттям Uptime Katalon, наприклад Cloudflare Access.",
    ...
    aboutKumaURL: "Якщо поле Uptime Katalon URL в налаштуваннях залишиться порожнім, за замовчуванням буде використовуватися посилання на проект на GitHub.",
