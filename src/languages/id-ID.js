export default {
    ...
    "disableauth.message2": "Ini untuk <strong>mereka yang memiliki autentikasi pihak ketiga</strong> diletakkan di depan Uptime Katalon, misalnya akses Cloudflare.",
    ...
    aboutKumaURL: "Jika Anda membiarkan bidang URL Uptime Katalon kosong, itu akan menjadi bawaan ke halaman Proyek Github.",
    ...
    trustProxyDescription: "Trust 'X-Forwarded-*' headers. Jika Anda ingin mendapatkan IP klien yang benar dan Uptime Katalon Anda dibalik layanan seperti Nginxor Apache, Anda harus mengaktifkan ini.",
