export default {
    ...
    aboutKumaURL: "如果保留 Uptime Katalon URL 为空，将会默认指向项目的 GitHub 页面。",
    ...
    trustProxyDescription: "信任 'X-Forwarded-*' 头。如果您的 Uptime Katalon 是通过 Nginx 或 Apache 等反代服务对外提供访问的话，则您应当启用本功能以获取正确的客户端 IP。",
