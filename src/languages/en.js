export default {
    ...
    "disableauth.message2": "It is designed for scenarios <strong>where you intend to implement third-party authentication</strong> in front of Uptime Katalon such as Cloudflare Access, Authelia or other authentication mechanisms.",
    ...
    aboutKumaURL: "If you leave the Uptime Katalon URL field blank, it will default to the Project GitHub page.",
    ...
    trustProxyDescription: "Trust 'X-Forwarded-*' headers. If you want to get the correct client IP and your Uptime Katalon is behind such as Nginx or Apache, you should enable this.",
