export default {
    ...
    "disableauth.message2": "Jest przeznaczony dla <strong>kogoś, kto ma autoryzację zewnętrzną</strong> przed Uptime Katalon, taką jak Cloudflare Access.",
    ...
    "Uptime Katalon URL": "Adres Uptime Katalon",
    ...
    aboutKumaURL: "Jeśli pozostawisz pole Adres Uptime Katalon puste, domyślnie będzie to strona projektu na GitHub.",
    ...
    trustProxyDescription: "Zaufaj nagłówkom 'X-Forwarded-*'. Jeśli chcesz uzyskać poprawne IP klienta, a twój Uptime Katalon jest za Nginx lub Apache, powinieneś to włączyć.",
