export default {
    ...
    "disableauth.message2": "Έχει σχεδιαστεί για σενάρια <strong>όπου σκοπεύετε να εφαρμόσετε έλεγχο ταυτότητας τρίτου μέρους</strong> μπροστά από το Uptime Katalon, όπως το Cloudflare Access, Authelia ή άλλους μηχανισμούς ελέγχου ταυτότητας.",
    ...
    "Uptime Katalon URL": "Uptime Katalon URL",
    ...
    aboutKumaURL: "Εάν αφήσετε κενό το πεδίο URL Uptime Katalon, θα είναι προεπιλεγμένο στη σελίδα Project GitHub..",
    ...
    About: "Σχετικά με το Uptime Katalon",
    ...
    trustProxyDescription: "Εμπιστευτείτε τις κεφαλίδες 'X-Forwarded-*'. Εάν θέλετε να λάβετε τη σωστή IP πελάτη και το Uptime Katalon σας βρίσκεται πίσω το Nginx ή το Apache, θα πρέπει να το ενεργοποιήσετε.",
