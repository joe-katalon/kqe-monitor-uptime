export default {
    ...
    "disableauth.message2": "Dies ist für Szenarien gedacht, <strong>in denen man eine externe Authentifizierung</strong> vor Uptime Katalon geschaltet hat, wie z.B. Cloudflare Access, Authelia oder andere Authentifizierungsmechanismen.",
    ...
    aboutKumaURL: "Wenn das Feld für die Uptime Katalon URL leer gelassen wird, wird standardmäßig die GitHub Projekt Seite verwendet.",
    ...
    trustProxyDescription: "Vertraue 'X-Forwarded-*' headern. Wenn man die richtige client IP haben möchte und Uptime Katalon hinter einem Proxy wie Nginx or Apache läuft, wollte dies aktiviert werden.",
