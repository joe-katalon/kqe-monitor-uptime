export default {
    ...
    "disableauth.message2": "이 기능은 <strong>Cloudflare Access와 같은 서드파티 인증</strong>을 Uptime Katalon 앞에 둔 사용자를 위한 기능이에요.",
    ...
    aboutKumaURL: "Uptime Katalon URL칸을 공백으로 두면 기본적으로 Github Project 페이지로 설정해요.",
