export default {
    ...
    aboutKumaURL: "Si vous laissez l'URL d'Uptime Katalon vierge, elle redirigera vers la page du projet GitHub.",
    ...
    "disableauth.message2": "Il est conçu pour les scénarios <strong>où vous avez l'intention d'implémenter une authentification tierce</strong> devant Uptime Katalon, comme Cloudflare Access, Authelia ou d'autres mécanismes d'authentification.",
    ...
    Domain: "Domaine",
    trustProxyDescription: "Faire confiance aux en-têtes 'X-Forwarded-*'. Si vous souhaitez obtenir la bonne adresse IP client et que votre Uptime Katalon est en retard, comme Nginx ou Apache, vous devez l'activer.",
