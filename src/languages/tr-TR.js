export default {
    ...
    "disableauth.message2": "Bu, Uptime Katalon'nın önünde Cloudflare Access gibi <strong>üçüncü taraf yetkilendirmesi olan</strong> kişiler içindir.",
    ...
    aboutKumaURL: "Uptime Katalon URL alanını boş bırakırsanız, varsayılan olarak Project GitHub sayfası olur.",
    ...
    trustProxyDescription: "'X-Forwarded-*' başlıklarına güvenin. Doğru istemci IP'sini almak istiyorsanız ve Uptime Katalon'nız Nginx veya Apache'nin arkasındaysa, bunu etkinleştirmelisiniz.",
