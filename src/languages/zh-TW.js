export default {
    ...
    trustProxyDescription: "信任 'X-Forwarded-*' 標頭。如果您想要取得正確的客戶端 IP，且您的 Uptime Katalon 架設於 Nginx 或 Apache 後方，您應啟用此選項。",
