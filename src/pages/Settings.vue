    ...
    computed: {
        ...
        subMenus() {
            return {
                ...
                placeholders: {
                    title: this.$t("Request Placeholders"),
                },
                backup: {
                    title: this.$t("Backup"),
                },
    ...
    methods: {
        ...
        loadSettings() {
            this.$root.getSocket().emit("getSettings", (res) => {
                ...
                // Initialize requestPlaceholders if not present
                if (this.settings.requestPlaceholders === undefined) {
                    this.settings.requestPlaceholders = [];
                }
